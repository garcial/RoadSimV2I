...
public class InterfaceAgent extends Agent{
	...
	public static final int MAXWORLDX = 1531; //1529 pixels // 1950
	public static final int MAXWORLDY = 870; // 817 pixels  // 860
	...
	protected void setup() {
		...
		if (drawGUI) {
			...
			SwingUtilities.invokeLater(new Runnable() {
				...
				@Override
				public void run() {
					canvasMap = new CanvasWorld(me, graphicalMap);	
				}
			});
	...
	//Setters and getters
	public CanvasWorld getCanvasMap() {
		return canvasMap;
	}
}
